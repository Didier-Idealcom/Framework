        ...
        'scanOptions' => [
            ...
            */
            'exclude' => [
                ...
                base_path('Modules/Email/Database'),
                base_path('Modules/Formulaire/Database'),
                base_path('Modules/Menu/Database'),
                base_path('Modules/Page/Database'),
                base_path('Modules/Product/Database'),
            ],
