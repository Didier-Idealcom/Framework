...
@if (isset($formulaire_field))
    @section('title_page', 'Edition du champ de formulaire')
    @section('breadcrumb')
        <span class="kt-subheader__separator kt-subheader__separator--v"></span>
        <div class="kt-subheader__breadcrumbs">
            <span class="kt-subheader__desc">{{ $formulaire_field->label_admin }}</span>
        </div>
    @stop
@else
    @section('title_page', 'Création d\'un nouveau champ de formulaire')
@endif

@section('subheader_toolbar')
<div class="kt-subheader__toolbar">
    <a href="{{ route('admin.formulaires_fields.index', $formulaire->id) }}" class="btn btn-default btn-bold">Back</a>
