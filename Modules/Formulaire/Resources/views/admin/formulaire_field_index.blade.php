...
@section('breadcrumb')
    <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
        ...
        <li class="m-nav__separator">-</li>
        <li class="m-nav__item">
            <a href="{{ route('admin.formulaires_fields.index', $formulaire->id) }}" class="m-nav__link">
...
@section('content_page')
    <div class="alert alert-brand alert-dismissible fade show" role="alert">
        ...
        <strong>INFO</strong> : This view is loaded from module: {!! config('framework.formulaire.config.name') !!}
    </div>
    ...
    <div class="m-portlet m-portlet--mobile">
        <div class="m-portlet__head">
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    ...
                    <h3 class="m-portlet__head-text">Liste des champs</h3>
                </div>
            </div>
            <div class="m-portlet__head-tools">
                <ul class="m-portlet__nav">
                    <li class="m-portlet__nav-item">
                        <a href="{{ route('admin.formulaires_fields.create', $formulaire->id) }}" class="m-portlet__nav-link btn btn-success m-btn m-btn--pill">
        ...
        <div class="m-portlet__body">
            ...
            <!--begin: Datatable -->
            <div class="m_datatable" id="formulaires_fields_datatable"></div>
            <!--end: Datatable -->
        </div>
    </div>
    <!-- end: Portlet -->
...
@push('scripts')
    <script type="text/javascript">
        jQuery(document).ready(function() {
            var datatable = $('#formulaires_fields_datatable').mDatatable({
                // datasource definition
                data: {
                    type: 'remote',
                    source: {
                        read: {
                            url: '{!! route('admin.formulaires_fields_datatable', $formulaire->id) !!}',
                            headers: {
