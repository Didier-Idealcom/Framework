...
@section('subheader_toolbar')
    <a href="{{ route('admin.formulaires.create') }}" class="btn btn-label-brand btn-bold">Ajouter</a>
...
@section('content_page')
    ...
    <div class="kt-portlet kt-portlet--mobile">
        <div class="kt-portlet__body kt-portlet__body--fit">
            ...
            <!--begin: Datatable -->
            <div class="kt-datatable" id="formulaires_datatable"></div>
            <!--end: Datatable -->
        </div>
    </div>
    <!--end::Portlet-->
...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        KTUtil.ready(function() {
            var target = '#formulaires_datatable';
