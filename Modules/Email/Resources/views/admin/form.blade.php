            ...
            <div class="m-portlet__head-wrapper">
                <div class="m-portlet__head-caption">
                    <div class="m-portlet__head-title">
                        ...
                        <?php if (isset($email)): ?>
                        <h3 class="m-portlet__head-text">Edition de l'e-mail : <?php echo $email->name; ?></h3>
                        <?php else: ?>
                        <h3 class="m-portlet__head-text">Création d'un nouvel e-mail</h3>
                        <?php endif; ?>
                    </div>
                </div>
                <div class="m-portlet__head-tools">
                    <a href="{{ route('admin.emails.index') }}" class="btn btn-secondary m-btn m-btn--icon m-btn--wide m-btn--md m--margin-right-10">
                        <span>
