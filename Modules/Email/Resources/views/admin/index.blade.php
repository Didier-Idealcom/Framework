    ...
    <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
        ...
        <li class="m-nav__item">
            <a href="javascript:;" class="m-nav__link">
                <span class="m-nav__link-text">E-mails</span>
            </a>
        </li>
        <li class="m-nav__separator">-</li>
        <li class="m-nav__item">
            <a href="{{ route('admin.emails.index') }}" class="m-nav__link">
...
@section('content_page')
    <div class="alert alert-brand alert-dismissible fade show" role="alert">
        ...
        <strong>INFO</strong> : This view is loaded from module: {!! config('framework.email.config.name') !!}
    </div>
    ...
    <div class="m-portlet m-portlet--mobile">
        <div class="m-portlet__head">
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    ...
                    <h3 class="m-portlet__head-text">Liste des e-mails</h3>
                </div>
            </div>
            <div class="m-portlet__head-tools">
                <ul class="m-portlet__nav">
                    <li class="m-portlet__nav-item">
                        <a href="{{ route('admin.emails.create') }}" class="m-portlet__nav-link btn btn-success m-btn m-btn--pill">
        ...
        <div class="m-portlet__body">
            ...
            <!--begin: Datatable -->
            <div class="m_datatable" id="emails_datatable"></div>
            <!--end: Datatable -->
        </div>
    </div>
    <!-- end: Portlet -->
...
@push('scripts')
    <script type="text/javascript">
        jQuery(document).ready(function() {
            var datatable = $('#emails_datatable').mDatatable({
                // datasource definition
                data: {
                    type: 'remote',
                    source: {
                        read: {
                            url: '{!! route('admin.emails_datatable') !!}',
                            headers: {
