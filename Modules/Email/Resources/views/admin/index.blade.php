...
@section('breadcrumb')
    ...
    <div class="kt-subheader__breadcrumbs">
        ...
        <a href="{{ route('admin.emails.index') }}" class="kt-subheader__breadcrumbs-link">E-mails</a>
    </div>
@stop

@section('subheader_toolbar')
    <a href="{{ route('admin.emails.create') }}" class="btn btn-label-brand btn-bold">Ajouter</a>
...
@section('content_page')
    ...
    <div class="kt-portlet kt-portlet--mobile">
        <div class="kt-portlet__body kt-portlet__body--fit">
            ...
            <!--begin: Datatable -->
            <div class="kt-datatable" id="emails_datatable"></div>
            <!--end: Datatable -->
        </div>
    </div>
    <!--end::Portlet-->
