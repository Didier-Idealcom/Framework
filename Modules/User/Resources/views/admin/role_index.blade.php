...
@section('breadcrumb')
    ...
    <div class="kt-subheader__breadcrumbs">
        ...
        <span class="kt-subheader__breadcrumbs-separator"></span>
        <a href="{{ route('admin.roles.index') }}" class="kt-subheader__breadcrumbs-link">Rôles</a>
    </div>
@stop

@section('subheader_toolbar')
    <a href="{{ route('admin.roles.create') }}" class="btn btn-label-brand btn-bold">Ajouter</a>
...
@section('content_page')
    ...
    <div class="kt-portlet kt-portlet--mobile">
        <div class="kt-portlet__body kt-portlet__body--fit">
            ...
            <!--begin: Datatable -->
            <div class="kt-datatable" id="roles_datatable"></div>
            <!--end: Datatable -->
        </div>
    </div>
    <!--end::Portlet-->
