            ...
            <div class="m-portlet__head-wrapper">
                <div class="m-portlet__head-caption">
                    <div class="m-portlet__head-title">
                        ...
                        <h3 class="m-portlet__head-text">Edition de la permission : <?php echo $permission->name; ?></h3>
                        <?php else: ?>
                        <h3 class="m-portlet__head-text">Création d'une nouvelle permission</h3>
                        <?php endif; ?>
                    </div>
                </div>
                <div class="m-portlet__head-tools">
                    <a href="{{ route('admin.permissions.index') }}" class="btn btn-secondary m-btn m-btn--icon m-btn--wide m-btn--md m--margin-right-10">
                        <span>
