...
@if (isset($permission))
    @section('title_page', 'Edition de la permission')
    @section('breadcrumb')
        <span class="kt-subheader__separator kt-subheader__separator--v"></span>
        <div class="kt-subheader__breadcrumbs">
            <span class="kt-subheader__desc">{{ $permission->name }}</span>
        </div>
    @stop
@else
    @section('title_page', 'Création d\'une nouvelle permission')
@endif

@section('subheader_toolbar')
<div class="kt-subheader__toolbar">
    <a href="{{ route('admin.permissions.index') }}" class="btn btn-default btn-bold">Back</a>
