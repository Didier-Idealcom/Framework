...
@if (isset($user))
    @section('title_page', 'Edition de l\'utilisateur')
    @section('breadcrumb')
        <span class="kt-subheader__separator kt-subheader__separator--v"></span>
        <div class="kt-subheader__breadcrumbs">
            <span class="kt-subheader__desc">{{ $user->name }} ({{ $user->email }})</span>
        </div>
    @stop
@else
    @section('title_page', 'Création d\'un nouvel utilisateur')
@endif

@section('subheader_toolbar')
<div class="kt-subheader__toolbar">
    <a href="{{ route('admin.users.index') }}" class="btn btn-default btn-bold">Back</a>
