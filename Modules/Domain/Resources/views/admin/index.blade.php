...
@section('subheader_toolbar')
    <div class="d-flex align-items-center">
        <!--begin::Button-->
        <a href="{{ route('admin.domains.create') }}" class="btn btn-light-primary font-weight-bold btn-sm px-4 font-size-base ml-2">Ajouter</a>
        <!--end::Button-->
...
@section('content_page')
    ...
    <div class="card card-custom">
        ...
        <div class="card-body">
            ...
            <!--begin::Datatable-->
            <div class="datatable datatable-bordered datatable-head-custom" id="domains_datatable"></div>
            <!--end::Datatable-->
        </div>
        <!--end::Card body-->
    </div>
