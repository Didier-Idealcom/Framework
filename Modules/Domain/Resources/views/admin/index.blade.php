...
@section('content_page')
    ...
    <div class="m-portlet m-portlet--mobile">
        <div class="m-portlet__head">
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    ...
                    <h3 class="m-portlet__head-text">Liste des domaines</h3>
                </div>
            </div>
            <div class="m-portlet__head-tools">
                <ul class="m-portlet__nav">
                    <li class="m-portlet__nav-item">
                        <a href="{{ route('admin.domains.create') }}" class="m-portlet__nav-link btn btn-success m-btn m-btn--pill m-btn--air">
        ...
        <div class="m-portlet__body">
            <!--begin: Datatable -->
            <div class="m_datatable" id="domains_datatable"></div>
            <!--end: Datatable -->
        </div>
    </div>
    <!-- end: Portlet -->
...
@push('scripts')
    <script type="text/javascript">
        jQuery(document).ready(function() {
            var datatable = $('#domains_datatable').mDatatable({
                // datasource definition
                data: {
                    type: 'remote',
                    source: {
                        read: {
                            url: '{!! route('admin.domains_datatable') !!}',
                            headers: {
