...
@if (isset($menu))
    ...
    @section('breadcrumb')
        ...
        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
            ...
            <li class="breadcrumb-item"><span class="text-muted">« {{ $menu->title }} »</span></li>
        </ul>
    @endsection
@else
...
@section('subheader_toolbar')
    <div class="d-flex align-items-center">
        <!--begin::Button-->
        <a href="{{ route('admin.menus.index') }}" class="btn btn-light-primary font-weight-bold btn-sm px-4 font-size-base ml-2">Back</a>
        <!--end::Button-->
        ...
        <div class="card-header card-header-tabs-line nav-tabs-line-3x">
            ...
            <div class="card-toolbar">
                <ul class="nav nav-tabs nav-bold nav-tabs-line nav-tabs-line-3x">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('admin.menuitems.index', $menu->id) }}">Items</a>
                    </li>
                </ul>
            </div>
            <!--end::Toolbar-->
