...
@if (isset($user))
    @section('title_page', 'Edition du menu')
    @section('breadcrumb')
        <span class="kt-subheader__separator kt-subheader__separator--v"></span>
        <div class="kt-subheader__breadcrumbs">
            <span class="kt-subheader__desc">{{ $menu->title }}</span>
        </div>
    @stop
@else
    @section('title_page', 'Création d\'un nouveau menu')
@endif

@section('subheader_toolbar')
<div class="kt-subheader__toolbar">
    <a href="{{ route('admin.menus.index') }}" class="btn btn-default btn-bold">Back</a>
