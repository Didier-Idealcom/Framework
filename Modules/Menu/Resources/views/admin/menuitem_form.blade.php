...
@if (isset($menuitem))
    ...
    @section('breadcrumb')
        ...
        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
            ...
            <li class="breadcrumb-item"><a href="{{ route('admin.menus.edit', $menu->id) }}" class="text-muted">« {{ $menu->title }} »</a></li>
            <li class="breadcrumb-item"><a href="{{ route('admin.menuitems.index', $menu->id) }}" class="text-muted">Menuitems</a></li>
            <li class="breadcrumb-item"><span class="text-muted">« {{ $menuitem->title_menu }} »</span></li>
        </ul>
    @endsection
@else
...
@section('subheader_toolbar')
    <div class="d-flex align-items-center">
        <!--begin::Button-->
        <a href="{{ route('admin.menuitems.index', $menu->id) }}" class="btn btn-light-primary font-weight-bold btn-sm px-4 font-size-base ml-2">Back</a>
        <!--end::Button-->
