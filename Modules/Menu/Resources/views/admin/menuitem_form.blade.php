...
@section('breadcrumb')
    <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
        ...
        <li class="m-nav__separator">-</li>
        <li class="m-nav__item">
            <a href="{{ route('admin.menuitems.index', isset($menuitem) ? $menuitem->menu_id : $menu->id) }}" class="m-nav__link">
            ...
            <div class="m-portlet__head-wrapper">
                <div class="m-portlet__head-caption">
                    <div class="m-portlet__head-title">
                        ...
                        <h3 class="m-portlet__head-text">Edition du menuitem : <?php echo $menuitem->title_menu; ?></h3>
                        <?php else: ?>
                        <h3 class="m-portlet__head-text">Création d'un nouveau menuitem</h3>
                        <?php endif; ?>
                    </div>
                </div>
                <div class="m-portlet__head-tools">
                    <a href="{{ route('admin.menus.index') }}" class="btn btn-secondary m-btn m-btn--icon m-btn--wide m-btn--md m--margin-right-10">
                        <span>
