...
@section('breadcrumb')
    ...
    <div class="kt-subheader__breadcrumbs">
        ...
        <a href="{{ route('admin.languages.index') }}" class="kt-subheader__breadcrumbs-link">Langues</a>
    </div>
@stop

@section('subheader_toolbar')
    <a href="{{ route('admin.languages.create') }}" class="btn btn-label-brand btn-bold">Ajouter</a>
...
@section('content_page')
    <div class="alert alert-brand fade show" role="alert">
        <div class="alert-text">
            <strong>INFO</strong> : This view is loaded from module: {!! config('framework.language.config.name') !!}
        </div>
    ...
    <div class="kt-portlet kt-portlet--mobile">
        <div class="kt-portlet__body kt-portlet__body--fit">
            ...
            <!--begin: Datatable -->
            <div class="kt-datatable" id="languages_datatable"></div>
            <!--end: Datatable -->
        </div>
    </div>
    <!--end::Portlet-->
...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        KTUtil.ready(function() {
            var target = '#languages_datatable';
